...
After June 28 12:00 PM MST, the knockout bracket is locked. No more changes anywhere.
...
## Group leader tools
Whoever creates a group is the **group leader**, marked with 👑. The leader can:
- **Delete** the group
- **Kick** members
- **Transfer leadership** to another member (click the 👑 next to their name)

If the leader leaves the group, leadership automatically passes to the next-earliest joiner.
